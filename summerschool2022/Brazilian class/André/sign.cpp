    // se o intervalo tem tam impar -> termina em + 
    // se tem tam par -> - 
    // 2 pares unindo == ok 
    // existe caso i-p? 
    // i-i? como faz a junção ? - inverte tudo do 2o 
    // p att o valor qd junta dois impares precisa soma no valor atual 2(s), sendo s a soma de tds
    // as posições pares e subtrair as impares 
    // p unir dois pares ou do tipo ipar-impar : soma normal -> soma a soma
    // seg -> tamanho do intervalo, soma no normal e soma invertida
    // das pos impares 
    // numa folha a gnt checa:
